...
enum SaveSlots { NO_SAVE_SLOT = -1 };

enum ScreenSizes { WIDE_SCR_XSIZE = 424, WIDE_SCR_XCENTER = 212 };

#define SCREEN_SCROLL_UP   (SCREEN_YCENTER - 16)
#define SCREEN_SCROLL_DOWN (SCREEN_YCENTER + 16)
...
typedef enum {
    // Mania-Specific filter uses, remove?
...
#define PLATFORM_BASE(class)                                                                                                                         \
    StateMachine<class> state;                                                                                                                       \
    StateMachine<class> stateCollide;                                                                                                                \
    int32 type;                                                                                                                                      \
    Vector2 amplitude;                                                                                                                               \
    int32 speed;                                                                                                                                     \
    bool32 hasTension;                                                                                                                               \
...
#define MANIA_UI_ITEM_BASE(class)                                                                                                                    \
    StateMachine<class> state;                                                                                                                       \
