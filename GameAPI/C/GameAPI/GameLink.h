...
typedef enum {
    ...
    STATUS_ERROR     = 500,
    STATUS_NOWIFI    = 503,
    R_STATUS_TIMEOUT   = 504, // i guess discord already defines STATUS_TIMEOUT, so just put R_ at the start
    STATUS_CORRUPT   = 505,
    STATUS_NOSPACE   = 506,
} StatusCodes;
...
typedef struct {
    ...
    void (*GetSettingsString)(const char *id, const char *key, String *, const char *fallback);
